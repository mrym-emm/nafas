...
try:
    with st.sidebar:
        ...
        with col1:
            ...
            select_location_state = st.selectbox("Select State", options=selected_state)
        ...
        with col2:
            ...
            if select_location_state != "Select State":
                ...
                select_location_city = st.selectbox(
                    "Select City", options=["Select City"] + cities_for_selected_state
                )
        ...
        # st.markdown(
        #     """<p style ="text-align: center";>Click me!</p>""", unsafe_allow_html=True
        # )
    ...
    if get_recommendation:
        ...
        with main_content_placeholder.container():
            ...
            if air_quality_category == "Good":
                ...
                if asthma_severity == "Moderate":
                    recommendation = "Safe with frequent breaks and monitoring symptoms"
                else:
